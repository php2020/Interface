-- FlightMap的默认数据
--
-- 一些默认的飞行时间要归功于FlightPath的作者Krwaz。
-- 
-- 此文件在本地化后加载
...
-- 分区
FLIGHTMAP_SUBZONES = {
    [FLIGHTMAP_ORGRIMMAR]    = FLIGHTMAP_DUROTAR, -- 奥格瑞玛 杜隆塔尔
    [FLIGHTMAP_THUNDERBLUFF] = FLIGHTMAP_MULGORE, -- 雷霆崖 莫高雷
    [FLIGHTMAP_UNDERCITY]    = FLIGHTMAP_TIRISFAL, -- 幽暗城 提瑞斯法林地
    [FLIGHTMAP_IRONFORGE]    = FLIGHTMAP_DUNMOROGH, -- 铁炉堡 丹莫罗
    [FLIGHTMAP_STORMWIND]    = FLIGHTMAP_ELWYNN, -- 暴风城 艾尔文森林
};

-- 默认飞行点数据
-- 请注意，节点名称不是国际化的。 这没关系因为一旦该飞行点出现，它们就会被更新在地图上，它们除了标签什么都不用。
FLIGHTMAP_HORDE_FLIGHTS = {
    ["2:671:703"] = {
        ["Name"]      = "恶齿村, 辛特兰",
        ["Zone"]      = FLIGHTMAP_HINTERLANDS, -- 辛特兰
        ["Continent"] = 2,
        ["Location"]  = {
        ...
        ["Flights"]   = {
            ["2:494:733"] = 170.182,   	-- Tarren Mill 塔伦米尔, Hillsbrad 希尔斯布莱德
            ["2:442:805"] = 285.968,   	-- Undercity 幽暗城, Tirisfal提瑞斯法林地
        },
        ["Costs"]     = {
            ["2:494:733"] = 330,  	-- Tarren Mill塔伦米尔, Hillsbrad 希尔斯布莱德
            ["2:442:805"] = 730,  	-- Undercity 幽暗城, Tirisfal Tirisfal提瑞斯法林地
        },
    },
    ["2:605:253"] = {
