...
Outfitter_cMountSpeedFormat = "速度提高(%d+)%%。"; -- For detecting when mounted
...
Outfitter_cAuthor = "非常棒的一键换装";
Outfitter_cTestersTitle = "Beta测试";
Outfitter_cTestersNames = "Airmid, Desiree, Fizzlebang, Harper, Kallah and Sumitra";
Outfitter_cSpecialThanksTitle = "汉化：";
