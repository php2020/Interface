...
local function barTooltipShow()
  ...
  if config.view == 1 or config.view == 2 then
    GameTooltip:AddDoubleLine("|cffffffff平均伤害", "|cffffffff" .. value)
    GameTooltip:AddDoubleLine("|cffffffff当前伤害", "|cffffffff" .. persec)
  elseif config.view == 3 or config.view == 4 then
    ...
    GameTooltip:AddDoubleLine("|cffffffff治疗", "|cffffffff" .. evalue)
    GameTooltip:AddDoubleLine("|cffaaaaaa总体", "|cffcc8888+" .. value - evalue)
    GameTooltip:AddLine(" ")
    GameTooltip:AddDoubleLine("|cffffffff当前治疗", "|cffffffff" .. epersec)
    GameTooltip:AddDoubleLine("|cffaaaaaa总体治疗", "|cffcc8888+" .. persec - epersec)
  end
...
window.btnSegment.caption:SetText("总体")
window.btnSegment.caption:SetAllPoints()
window.btnSegment.tooltip = { "数据选项", "|cffffffff总体, 当前" }
...
window.btnMode.caption:SetText("模式: 伤害")
window.btnMode.caption:SetAllPoints()
window.btnMode.tooltip = { "选择模式", "|cffffffff平均伤害, 当前伤害, 平均治疗, 当前治疗" }
...
for name, template in pairs(menubuttons) do
  ...
  button.caption:SetText(mrbcat_tab[name])
...
window.Refresh = function(force, report)
  ...
  if force then
    ...
    elseif config.segment == 1 then
      ...
      window.btnSegment.caption:SetText("当前")
    end
