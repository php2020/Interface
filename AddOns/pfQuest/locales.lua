local locales = {
    ...
    ['Quest Tracker Unfold Objectives'] = '任务跟踪器展开目标',
    ['Quest Objective Spawn Points (World Map)']="任务目标标记（世界地图）",
    ['Quest Objective Spawn Points (Mini Map)']="任务目标标记（小地图）",
    ['Quest Objective Icons (World Map)']='任务目标图标（世界地图）',
    ['Quest Objective Icons (Mini Map)']='任务目标图标（迷你地图）',



}

pfQuest_Loc = setmetatable(locales or {} , { __index = function(tab,key)
