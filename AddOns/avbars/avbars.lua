...
function gvalley_AnnounceBG(gINDEX,gbutton)
		...
		if gbutton == "LeftButton" then SendChatMessage(GV_Faction[gINDEX]..getglobal("gvalleyT"..gINDEX.."y"):GetText().." - "..getglobal("gvalleyT"..gINDEX.."x"):GetText().."剩余","SAY") end
		if gbutton == "RightButton" then SendChatMessage(GV_Faction[gINDEX]..getglobal("gvalleyT"..gINDEX.."y"):GetText().." - "..getglobal("gvalleyT"..gINDEX.."x"):GetText().."剩余","BATTLEGROUND") end
end
