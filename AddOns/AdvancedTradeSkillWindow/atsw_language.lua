...
ATSW_VERSION = "ATSW ".. GetAddOnMetadata("AdvancedTradeSkillWindow", "Version").." wowstory.cn";
...
elseif (GetLocale()=="zhCN") then
	...
	ATSW_SORTBYHEADERS = "按类别排序";
	ATSW_SORTBYNAMES = "按名字排序";
	ATSW_SORTBYDIFFICULTY = "按难度排序";
	ATSW_CUSTOMSORTING = "自定义排序";
	ATSW_QUEUE = "队列";
	ATSW_QUEUEALL = "所有队列";
	ATSW_DELETELETTER = "删";
	ATSW_STARTQUEUE = ">制造<";
	ATSW_STOPQUEUE = "停止生产";
	ATSW_DELETEQUEUE = "空队列";
	ATSW_ITEMSMISSING1 = "你需要以下物品来生产 ";
	ATSW_ITEMSMISSING2 = ":";
	ATSW_FILTERLABEL = "过滤:";
	ATSW_REAGENTLIST1 = "生产 1x ";
	ATSW_REAGENTLIST2 = " 需要下列材料:";
	ATSW_REAGENTFRAMETITLE = "处理队列需要下列材料:";
	ATSW_REAGENTBUTTON = "材料";
	ATSW_REAGENTFRAME_CH1 = "背包";
	ATSW_REAGENTFRAME_CH2 = "银行";
	ATSW_REAGENTFRAME_CH3 = "小号";
	ATSW_REAGENTFRAME_CH4 = "商人";
	ATSW_ALTLIST1 = "以下每个小号 '";
	ATSW_ALTLIST2 = "':";
	ATSW_ALTLIST3 = " 在背包 ";
	ATSW_ALTLIST4 = " 在银行 ";
	ATSW_OPTIONS_TITLE = "ATSW 设置";
	ATSWOFIB_TEXT = "在计算可生产物品的数量时，考虑银行的物品";
	ATSWOFIA_TEXT = "在计算可生产项目的数量时，考虑背包中的物品和你的小号中的物品。";
	ATSWOFIM_TEXT = "在计算可生产项目数量时考虑可在别处商贩购买物品";
	ATSWOFUCB_TEXT = "只显示可生产项目的总计数";
	ATSWOFSCB_TEXT = "显示背包中可生产项目的数量";
	ATSWOFTB_TEXT = "启用配方提示";
	ATSW_OPTIONSBUTTON = "设置";
	ATSW_BUYREAGENTBUTTON = "从目前选定的商家购买材料";
	ATSWOFAB_TEXT = "在与供应商交谈时自动购买当前队列中可能和必要的任何材料";
	ATSW_AUTOBUYMESSAGE = "ATSW 会自动购买以下物品:";
	ATSW_TOOLTIP_PRODUCABLE = "可用你的背包中的材料制造数为-> "
	ATSW_TOOLTIP_NECESSARY = "制造需要下列材料：";
	ATSW_TOOLTIP_BUYABLE = " (可买的)";
	ATSW_TOOLTIP_LEGEND = "(物品在背包 / 物品在银行 / 物品在小号)";
	ATSW_CONTINUEQUEUE = "继续队列";
	ATSW_ABORTQUEUE = "中止";
	ATSWCF_TITLE = "继续生产队列中的物品?";
	ATSWCF_TEXT = "由于补丁1.10，点击按钮是必需的，以便能够产生物品. 点击'继续', 才能继续生产.";
	ATSWCF_TITLE2 = "队列中的下一个物品是:";
	ATSW_CSBUTTON = "编辑";
	ATSW_AUTOBUYBUTTON_TOPTEXT = "这个商人卖你需要的材料!";
	ATSW_AUTOBUYBUTTON_TEXT = "买材料";
	ATSW_AUTOBUYCLOSEBUTTON_TEXT = "不";
	ATSW_SHOPPINGLISTFRAMETITLE = "需要在所有保存的ATSW队列中生成物品的材料清单:";
	ATSWOFSLB_TEXT = "在拍卖行展示购物清单";
	ATSW_ENCHANT = "附魔";
	ATSW_ACTIVATIONMESSAGE = "ATSW已被";
	ATSW_ACTIVATED = "激活当前副职业";
	ATSW_DEACTIVATED = "禁用当前副职业";
	...
	ATSWCS_TITLE = "ATSW - 配方排序编辑器";
	ATSWCS_TRADESKILLISTTITLE = "未分类的配方";
	ATSWCS_CATEGORYLISTTITLE = "配方分类";
	ATSWCS_ADDCATEGORY = "新类别";
