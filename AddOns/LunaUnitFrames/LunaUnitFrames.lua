...
LunaUF.AllianceCheck = {["Dwarf"] = true, ["Human"] = true, ["Gnome"] = true, ["NightElf"] = true}
...
local function BarSetStatusBarTexture(self, texture, layer)
    local validLayers = {["BACKGROUND"] = true, ["BORDER"] = true, ["ARTWORK"] = true, ["OVERLAY"] = true, ["HIGHLIGHT"] = true}
    if texture then
        local changed
...
-- Constant Values --------------------------------------------------------------------------
LunaUF.constants = {
    backdrop = {bgFile = "Interface\\Tooltips\\UI-Tooltip-Background", tile = true, tileSize = 16, insets = {left = -1.5, right = -1.5, top = -1.5, bottom = -1.5}},
    icon = "Interface\\AddOns\\LunaUnitFrames\\media\\textures\\icon",
    AnchorPoint = {["UP"] = "BOTTOM", ["DOWN"] = "TOP", ["RIGHT"] = "LEFT", ["LEFT"] = "RIGHT"},
    RaidClassMapping = {[1] = "WARRIOR", [2] = "DRUID", [3] = LunaUF.AllianceCheck[LunaUF.playerRace] and "PALADIN" or "SHAMAN", [4] = "WARLOCK", [5] = "PRIEST", [6] = "MAGE", [7] = "ROGUE", [8] = "HUNTER", [9] = "PET"},
    CLASS_ICON_TCOORDS = {
    ...
    barorder = {horizontal = {[1] = "portrait", [2] = "healthBar", [3] = "powerBar", [4] = "castBar", [5] = "emptyBar"}, vertical = {}},
    specialbarorder = {
        ["player"] = {horizontal = {[1] = "portrait", [2] = "healthBar", [3] = "powerBar", [4] = "castBar", [5] = "emptyBar", [6] = "druidBar", [7] = "totemBar", [8] = "reckStacks", [9] = "xpBar"}, vertical = {}},
        ["pet"] = {horizontal = {[1] = "portrait", [2] = "healthBar", [3] = "powerBar", [4] = "castBar", [5] = "xpBar", [6] = "emptyBar"}, vertical = {}},
        ["target"] = {horizontal = {[1] = "portrait", [2] = "healthBar", [3] = "powerBar", [4] = "castBar", [5] = "comboPoints", [6] = "emptyBar"}, vertical = {}},
        ["raid"] = {horizontal = {[1] = "portrait", [2] = "castBar", [3] = "emptyBar"}, vertical = {[1] = "healthBar", [2] = "powerBar"}}
    }
}
--------------------------------------------------------------------------------------------
...
function LunaUF:ProfileSwitcher()
    if (not LunaDB.ProfileSwitcher) or (event == "PARTY_MEMBERS_CHANGED" and UnitInRaid("player")) then
        return
    end
    local GrpMode = 0
