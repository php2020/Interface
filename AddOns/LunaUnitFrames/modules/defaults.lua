...
LunaUF.defaults = {
	profile = {
		...
		units = {
			player = {
				enabled = true,
				healthBar = { enabled = true, classGradient = false, colorType = "class", reactionType="npc", size = 10, invert = false, vertical = false },
				powerBar = { enabled = true, size = 3, invert = false, manaUsage = false },
			...
			pet = {
				enabled = true,
				healthBar = {enabled = true, classGradient = false, colorType = "none", reactionType = "happiness", size = 9 },
				powerBar = { enabled = true, size = 3 },
				emptyBar = { enabled = false, size = 3 },
				portrait = { enabled = true, type = "3D", side = "left", size = 6 },
				auras = {
					enabled = true,
			...
			pettarget = {
				enabled = false,
				healthBar = { enabled = true, classGradient = false, colorType = "class", reactionType="npc", size = 9 },
				powerBar = { enabled = true, size = 3 },
				emptyBar = { enabled = false, size = 3 },
			...
			target = {
				enabled = true,
				healthBar = { enabled = true, classGradient = false, colorType = "class", reactionType="npc", size = 10 },
				powerBar = { enabled = true, size = 3 },
			...
			party = {
				...
				player = false,
				inraid = true,
				healthBar = { enabled = true, classGradient = true, colorType = "class", reactionType="npc", size = 10 },
				powerBar = { enabled = true, size = 3 },
				emptyBar = { enabled = false, size = 3 },
				portrait = { enabled = true, type = "3D", side = "left", size = 6 },
				auras = {
			...
			raid = {
				...
				petgrp = false,
				healthBar = { enabled = true, classGradient = true, colorType = "class", reactionType="npc", size = 10, vertical = false },
				powerBar = { enabled = true, vertical = false, size = 1 },
				emptyBar = { enabled = false, size = 3 },
				portrait = { enabled = false, type = "3D", side = "left", size = 6 },
				auras = {
					enabled = false,
