...
function TitanPanelTrackerButton_OnClick(button)
	...
	if ( button == "RightButton" ) then
		if ( GameTooltip:IsVisible() ) then
        	...
        	if ( position == TITAN_PANEL_PLACE_TOP ) then
            	   	TitanPanelTracker_Button_Menu.point = "TOPLEFT";
         	      	TitanPanelTracker_Button_Menu.relativePoint = "BOTTOMLEFT";
        	else
          	     	TitanPanelTracker_Button_Menu.point = "BOTTOMLEFT";
         	      	TitanPanelTracker_Button_Menu.relativePoint = "TOPLEFT";
        	end
        	ToggleDropDownMenu(1, nil, TitanPanelTracker_Button_Menu, "TitanPanelBarButton", x - 40, 0);
	end
end
...
function TitanPanelTrackerRightClickMenu_OnLoad()
       	UIDropDownMenu_Initialize(TitanPanelTracker_Button_Menu, TitanPanelTrackerRightClickMenu_CreateMenu, "MENU");
end

function TitanPanelTrackerRightClickMenu_CreateMenu(level)
	local info = {};
	...
	if ( level == 2 ) then		
		...
		TitanPanelRightClickMenu_PrepareTrackerMenu();
	end
end
