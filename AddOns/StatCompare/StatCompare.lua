...
function StatCompare_OnLoad()
	...
	DEFAULT_CHAT_FRAME:AddMessage("StatCompare 已加载. "..GREEN_FONT_COLOR_CODE.."By 60addons 修复 "..FONT_COLOR_CODE_CLOSE);
	--DEFAULT_CHAT_FRAME:AddMessage("增强版 - "..GREEN_FONT_COLOR_CODE.."By 60addons 修复 "..FONT_COLOR_CODE_CLOSE);
