...
WIM_DESCRIPTION = [[
WIM (WoW Instant Messenger)|cffffffff未设置汉化（4903747）|r


用户命令：
/wim			|cffffffff- 设置窗口|r
/wim history	|cffffffff- 查看历史消息|r
/wim help		|cffffffff- 帮助窗口|r


高级命令：
/wim reset			|cffffffff- 恢复默认设置|r
/wim reset filters	|cffffffff- 重置所有过滤器|r
/wim clear history	|cffffffff- 清空历史记录|r
