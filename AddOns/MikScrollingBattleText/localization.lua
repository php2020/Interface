...
MikSBT.WINDOW_TITLE = "战斗数值事件显示器 " .. MikSBT.VERSION_STRING ..
                          " - \124cffF58CBA\124h60addons版\124h\124r";
...
MikSBT.MSG_SEARCH_ENABLE =
    L["Event search mode has been enabled.  Searching for: "];
...
MikSBT.AVAILABLE_FONTS = {
    [1] = {Name = "Adventure", Path = "Fonts\\FZJZJW.ttf"},
    ...
    [7] = {
        Name = "Porky",
        Path = "Interface\\AddOns\\MikScrollingBattleText\\Font\\默认字体.ttf"
    },
...
MikSBT.AVAILABLE_STANCES = {
    [1] = {
        Name = "|cffC79C6E战斗姿态|r/|cffFF7D0A熊形态|r/|cffFFF569潜行|r/|cffF58CBA虔诚光环"
    },
    [2] = {
        Name = "|cffC79C6E防御姿态|r/|cffFF7D0A水栖形态|r/|cffF58CBA惩罚光环"
    },
    [3] = {
        Name = "|cffC79C6E狂暴姿态|r/|cffFF7D0A猎豹形态|r/|cffF58CBA专注光环"
    },
...
MikSBT.DEFAULT_CONFIG = {
    ...
    BlizzardFontSettings = {Normal = {FontIndex = 6}},
    DisplaySettings = {
        Incoming = {
            Show = true,
    ...
    Triggers = {
        MSBT_TRIGGER_LOW_HEALTH = {
            ...
            TriggerSettings = {TriggerType = 1, Threshold = 40},
        ...
        MSBT_TRIGGER_CLEARCAST = {
            ...
            TriggerSettings = {
                ...
                SearchPatterns = {
                    string.format(AURAADDEDSELFHELPFUL, BS["Clearcasting"])
                }
            },
                ...
                SearchPatterns = {
                    string.format(
                        AURAADDEDSELFHELPFUL,
                            string.gsub(BS["Windfury Totem"], "-", "%%-"))
                } -- "Vous gagnez Totem Furie-des-vents" -- escape char !
            },
        ...
        MSBT_TRIGGER_NIGHTFALL = {
            ...
            TriggerSettings = {
                ...
                TriggerEvents = {"CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS"},
                SearchPatterns = {
                    string.format(AURAADDEDSELFHELPFUL, BS["Shadow Trance"])
                }
            },
