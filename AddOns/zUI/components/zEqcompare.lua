...
zUI:RegisterComponent("zEqcompare", function()
  ...
  zUI.api.HookScript(GameTooltip, "OnShow", zUI.eqcompare.GameTooltipShow)
  
  if C.tooltip.compare.basestats == "1" then
    zUI.api.HookScript(ShoppingTooltip1, "OnShow", zUI.eqcompare.ShoppingTooltipShow)
    zUI.api.HookScript(ShoppingTooltip2, "OnShow", zUI.eqcompare.ShoppingTooltipShow)
  end
end)
