...
-------------------------------------------------------------------
	...
	do -- Generate Config UI
		...
		CreateGUIEntry(zUI.mlocals["General"], nil, function()
			...
			CreateConfig(nil, T[zUI.mlocals["Clean Up"]], C.quality, "clean_up", "checkbox")--聊天职业色
			CreateConfig(nil, T["聊天显示人物等级"], C.quality, "showlevel", "checkbox")--显示聊天等级
			...
			CreateConfig(nil, T["启用大拾取框"], C.quality, "bigloot", "checkbox")
		...
		CreateGUIEntry(zUI.mlocals["Actionbars"], nil, function()
			...
			CreateConfig(nil, T["隐形狮鹫的同时隐藏经验条"], C.global, "hide_xpbar", "checkbox")
			CreateConfig(nil, T["显示隐藏（姿态栏）"], C.global, "hide_shift", "checkbox")
			CreateConfig(nil, T["显示隐藏（动作栏翻页按钮）"], C.global, "hide_paging", "checkbox")
		...
		CreateGUIEntry(zUI.mlocals["Nameplates"], nil, function()
			...
			CreateConfig(nil, T["显示隐藏宽姓名板"], C.nameplates, "bg_nameplates", "checkbox")
			--mrbcat -20230808 隐藏小动物姓名版
			--CreateConfig(nil, T["显示小动物姓名版"], C.nameplates, "critters", "checkbox")
		end)
