zUI:RegisterComponent("zAura-增益减益", function ()
...
local OnUpdate = function()
    for i = 1, 4 do
        ...
        if  d then
            ...
            --if  skin.enable then
				zUI.api.zSkinColor(_G[f], r*1.5, g*1.5, b*1.5)
            --end
            d:SetAlpha(0)
...
for i = 1, 16 do
	...
	zUI.api.zSkin(zUI.PlayerDebuffs[i], 0);
	zUI.api.zSkinColor(zUI.PlayerDebuffs[i], 0, 1, 0);
	----
...
function zPlayerDebuffs_Event()
	for i = 1, 16 do
        ...
        if  bu and icon then
            ...
            --if  skin.enable then
				zUI.api.zSkinColor(bu, colour.r*1.4, colour.g*1.4, colour.b*1.4)
            --end
...
zUI.api.hooksecurefunc("TargetDebuffButton_Update", AddAllTargetBuffs,true)
