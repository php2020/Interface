...
local libspell =zUI.api.libspell
...
zUI.api.hooksecurefunc("UseContainerItem", function(bag, slot)
  zUI.ICON = GetContainerItemInfo(bag, slot)
end)

zUI.api.hooksecurefunc("CastSpell", function(id, bookType)
...
zUI.api.hooksecurefunc("CastSpellByName", function(spellName, target)
 -- _, lastrank = zUI.api.libspell.GetSpellInfo(spell)
...
zUI.api.hooksecurefunc("UseAction", function(slot, target, button)
