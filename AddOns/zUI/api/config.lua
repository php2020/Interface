...
zUI:UpdateConfig( "minimap", nil, "zpfQueset_btn", "0")


zUI:UpdateConfig( "nameplates", nil, "castbarcolor", "1.0, 0.7, 0.0, 1")
zUI:UpdateConfig( "nameplates", nil, "flat_health_textures", "1")
...
zUI:UpdateConfig( "nameplates", nil, "raidiconsize", "26")
zUI:UpdateConfig( "nameplates", nil, "players", "0")
zUI:UpdateConfig( "nameplates", nil, "critters", "1")
...
zUI:UpdateConfig( "nameplates", nil, "targethighlight", "1")
zUI:UpdateConfig( "nameplates", nil, "targetzoom", "0")
zUI:UpdateConfig( "nameplates", nil, "bg_nameplates", "0")
