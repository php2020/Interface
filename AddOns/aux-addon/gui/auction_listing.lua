...
--            end
    ...
    {
        title = {G_AUCTION_BID_NPER_ITEM, G_AUCTION_BID_NPER_STACK},
        width = .125,
        align = 'RIGHT',
        isPrice = true,
        fill = function(cell, record)
    ...
    {
        title = {G_AUCTION_BUYOUT_NPER_ITEM,  G_AUCTION_BUYOUT_NPER_STACK},
...
M.auctions_columns = {
    ...
    },
    {
        ...
        align = 'CENTER',
        fill = function(cell, record)
            cell.text:SetText(record.high_bidder or aux.color.red (G_NO_BIDS))
        end,
        cmp = function(record_a, record_b, desc)
