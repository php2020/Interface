...
do
    ...
    label:SetText(G_SHOW_HIDDEN_ITEMS)
...
bid_listing:SetColInfo{
    {name=G_AUCTIONS, width=.17, align='CENTER'},
    {name=G_TIME_NLEFT, width=.11, align='CENTER'},
    {name=G_STACK_NSIZE, width=.11, align='CENTER'},
    {name=G_AUCTION_BID_NPER_ITEM, width=.4, align='RIGHT'},
    {name=G_HIST_NVALUE, width=.21, align='CENTER'},
}
...
buyout_listing:SetColInfo{
	{name=G_AUCTIONS, width=.17, align='CENTER'},
	{name=G_TIME_NLEFT, width=.11, align='CENTER'},
	{name=G_STACK_NSIZE, width=.12, align='CENTER'},
	{name=G_AUCTION_BUYOUT_NPER_ITEM, width=.4, align='RIGHT'},
	{name=G_HIST_NVALUE, width=.20, align='CENTER'},
}
...
do
    ...
    slider.label:SetText(G_STACK_SIZE)
...
do
    ...
    slider.editbox:SetNumeric(true)
    slider.label:SetText(G_STACK_COUNT)
...
do
    ...
    local label = gui.label(checkbox, gui.font_size.small)
    label:SetPoint('LEFT', checkbox, 'RIGHT', 4, 1)
    label:SetText(G_HIDE_THIS_ITEM)
...
do
    ...
    do
        ...
        label:SetText(G_UNIT_STARTING_PRICE)
    end
    do
...
do
    ...
    do
        local label = gui.label(editbox, gui.font_size.small)
        label:SetPoint('BOTTOMLEFT', editbox, 'TOPLEFT', -2, 1)
        label:SetText(G_UNIT_BUYOUT_PRICE)
    end
    do
        local label = gui.label(editbox, 14)
        label:SetPoint('LEFT', editbox, 'RIGHT', 8, 0)
...
function aux.handle.LOAD()
	if not aux.account_data.post_bid then
		...
		buyout_listing:SetColInfo{
			{name=G_AUCTIONS, width=.15, align='CENTER'},
			{name=G_TIME_NLEFT, width=.15, align='CENTER'},
			{name=G_STACK_NSIZE, width=.15, align='CENTER'},
			{name=G_AUCTION_BUYOUT_NPER_ITEM, width=.4, align='RIGHT'},
			{name=G_HIST_NVALUE, width=.15, align='CENTER'},
		}
	end
end