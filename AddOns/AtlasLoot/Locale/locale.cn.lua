...
AL:RegisterTranslations("zhCN", function()
    return {
        ["AtlasLoot"] = "AtlasLoot掉落查询",
        ["Atlas"] = "Atlas",
        ["AtlasLoot Enhanced"] = "AtlasLoot 增强型",
        ...
        ["ALT+Click to use WishList."] = "ALT+Click 愿望清单.",
        ["Left-click to open AtlasLoot.\nMiddle-click for AtlasLoot options.\nRight-click and drag to move this button."] = "左键单击以打开AtlasLoot。\n鼠标中键单击可获得AtlasLoot选项。\n右键单击并拖动可移动此按钮。",
        ["Various Locations"] = "多个位置",
        ["NoticeFrame"] = "问题反馈 |cff3366CChttps://github.com/Lexiebean/AtlasLoot/issues|r .",
        ...
        ["Button Radius"] = "按钮半径",
        ["Reset Position"] = "重置位置",
        ["Minimap button has been reset!"] = "小地图按钮已重置",
        ["has been reset!"] = "已经重置!",
        ["|cff9d9d9dALT+Click to clear|r"] = "|cff9d9d9dALT+左键清除|r",
        ...
        ["If checked, AtlasLoot searches item names for a partial match."] = "如果选中，AtlasLoot 会搜索项目名称以查找部分匹配项。",
        ...
        ["To cast "] = "施放",
        [" the following items are needed:"] = " 需要下列项目:",
        [" you need this: "] = " 需要: ",
        ["To craft "] = "制作 ",
        [" the following reagents are needed:"] = " 需要以下试剂:",
        ...
        ["|cffccccccRight-Click + Drag|r Move Minimap Button"] = "|cffccccccRight-Click + Drag|r Move Minimap Button",
        ["Options"] = "设置",
        ["Collections"] = "套装/收藏",
        ["Factions"] = "阵营",
        ["World Events"] = "世界事件",
        ...
        ["Crafted Sets - Leatherworking"] = "制造出的套装 - 龙鳞制皮",
        ...
        ["Fel Iron Chain"] = "魔铁链甲",
        ["Augerer's Attire"] = "卜卦者的装束",
        ["Shadoweave"] = "暗纹",
        ["Diviner's Garments"] = "占卜者的装束",
        ["Pillager's Garb"] = "掠夺者的装备",
        ["Bloodvine Garb"] = "血藤",
        ...
        ["Grifter's Armor"] = "欺诈者的护甲",
        ["Primalist's Trappings"] = "原始使者的装备",
        ["Volcanic Armor"] = "火山",
        ...
        ["Dungeon 1 Set"] = "地下城 1 套装",
        ["Dungeon 2 Set"] = "地下城 2 套装",
        ["D2 Summonable"] = "D2 汇总",
        ["Tier 1 Sets"] = "等级1套装",
        ["Tier 2 Sets"] = "等级2套装",
        ["Tier 3 Sets"] = "等级3套装",
        ...
        ["PvP Accessories - Alliance"] = "PVP奖励联盟",
        ["PvP Accessories - Horde"] = "PvP奖励部落",
        ["PvP Rewards"] = "PvP奖励",
        ...
        ["Defias Pirate"] = "迪菲亚海盗",
        ["Overseer/Taskmaster"] = "监工/任务主管",
        ["Prisoner/Insurgent/Convict"] = "俘虏/叛逆者/囚徒",
        ["Defender"] = "守护者",
        ["Protector"] = "守护者",
        ["Myrmidon"] = "军团士兵",
        ["Champion"] = "勇士",
        ...
        ["Spire Spider/Spiderling"] = "塔尖蜘蛛/蜘蛛幼崽",
        ...
        ["The Grim Guzzler"] = "阴森的大咽喉",
        ["Summoner's Tomb"] = "召唤师之墓",
        ...
        ["Blackwing Lair"] = "|cffff0000[团队]|cffffd200 黑翼之巢",
        ["Hateforge Quarry"] = "|cffffffff[50-60]|cffffd200 仇恨熔炼采矿场",
        ["High Foreman Bargul Blackhammer"] = "高级工头巴格尔·黑锤",
        ["Engineer Figgles"] = "工程师费格尔斯",
        ["Corrosis"] = "腐蚀",
        ["Hatereaver Annihilator"] = "仇恨毁灭者",
        ["Hargesh Doomcaller"] = "哈格什·末日呼唤者",
        ["The Crescent Grove"] = "|cffffffff[32-38]|cffffd200 新月林地",
        ["Grovetender Engryss"] = "树荫看护者恩格里斯",
        ["Keeper Ranathos"] = "守护者拉纳索斯",
        ["High Priestess A'lathea"] = "高阶祭司阿拉西娅",
        ["Fenektis the Deceiver"] = "欺诈者费内克提斯",
        ["Master Raxxieth"] = "拉克希斯主母",
        ["Karazhan Crypt"] = "|cffffffff[58-60]|cffffd200 卡拉赞：地穴",
        ["Marrowspike"] = "骨髓穿刺者",
        ["Hivaxxis"] = "海瓦希斯",
        ["Corpsemuncher"] = "吞噬尸体者",
        ["Guard Captain Gort"] = "护卫队长戈尔特",
        ["Archlich Enkhraz"] = "上位亡灵法师恩克拉兹",
        ["Commander Anderson"] = "指挥官安德森",
        ["Alarus"] = "阿拉鲁斯",
        ["Half-Buried Treasure Chest"] = "半埋宝箱",
        ["Caverns of Time: Black Morass"] = "|cffffffff[60]|cffffd200 时光之穴：黑色沼泽",
        ["Chronar"] = "克罗纳尔",
        ["Harbinger Aph'ygth"] = "先驱者阿弗格斯",
        ["Epidamu"] = "艾皮达姆",
        ["Drifting Avatar of Time"] = "时光漂流化身",
        ["Time-Lord Epochronos"] = "时光领主埃波克罗诺斯",
        ["Mossheart"] = "苔心",
        ["Rotmaw"] = "腐喉",
        ["Antnormi"] = "安特诺米",
        ["Infinite Chromie"] = "无尽的克罗米",
        ["Stormwind Vault"] = "|cffffffff[60]|cffffd200 暴风城地牢",
        ["Aszosh Grimflame"] = "阿索什·格里姆烬",
        ["Tham'Grarr"] = "萨姆加尔",
        ["Black Bride"] = "黑暗新娘",
        ["Damian"] = "达米安",
        ["Volkan Cruelblade"] = "沃肯·残刃",
        ["Arc'tiras / Vault Armory Equipment"] = "阿克提拉斯 / 地下城武库装备",
        ...
        ["Molten Core"] = "|cffff0000[团队]|cffffd200 熔火之心",
        ["Faerlina"] = "费尔琳娜",
        ["Razuvious"] = "拉祖维奥斯",
        ["Gothik"] = "格雷高克",
        ["Noth"] = "诺斯",
        ["Heigan"] = "海根",
        ["Naxxramas"] = "|cffff0000[团队]|cffffd200 纳克萨玛斯",
        ["Onyxia's Lair"] = "|cffff0000[团队]|cffffd200 奥妮克希亚的巢穴",
        ...
        ["Ruins of Ahn'Qiraj"] = "|cffff0000[团队]|cffffd200 安其拉废墟",
        ["Kurinnaxx"] = "库林纳克斯",
        ...
        ["Temple of Ahn'Qiraj"] = "|cffff0000[团队]|cffffd200 安其拉神庙",
        ...
        ["Hakkar"] = "哈卡",
        ["Zul'Gurub"] = "|cffff0000[团队]|cffffd200 祖尔格拉布",
        ["Emerald Dragons"] = "翡翠龙",
        ["Druid"] = "德鲁伊",
        ["Hunter"] = "猎人",
        ["Mage"] = "法师",
        ...
        ["Scarlet Monastery (Armory)"] = "|cffffffff[32-41]|cffffd200 血色修道院 (武器库)",
        ["Scarlet Monastery (Cathedral)"] = "|cffffffff[35-45]|cffffd200 血色修道院(大教堂)",
        ["Scarlet Monastery (Library)"] = "|cffffffff[28-39]|cffffd200 血色修道院(大教堂)",
        ...
        ["The Defilers"] = "污染者",
        ["Frostwolf Clan"] = "|cffff0000霜狼氏族",
        ["Hydraxian Waterlords"] = "海达希亚水元素领主",
        ["Gelkis Clan Centaur"] = "盖尔基斯半人马族",
        ["The League of Arathor"] = "阿拉托尔联盟",
        ["Magram Clan Centaur"] = "马格拉姆族半人马",
        ["Stormpike Guard"] = "雷矛卫队",
        ["Thorium Brotherhood"] = "瑟银兄弟会",
        ["Timbermaw Hold"] = "木喉要塞",
        ["Wardens of Time"] = "时间守望者",
        ["Wintersaber Trainers"] = "冬刀训练师",
        ["Zandalar Tribe"] = "赞达拉尔部落",
        ["Apprentice"] = "学徒",
        ["Journeyman"] = "熟练工",
        ["Expert"] = "专家",
        ["Artisan"] = "大师",
        ...
        ["Armorsmith"] = "铸甲师",
        ["Weaponsmith"] = "铸剑师",
        ["Master Axesmith"] = "大师级斧锻师",
        ["Master Hammersmith"] = "大师级锤锻师",
        ["Master Swordsmith"] = "剑匠大师",
        ["Enchanting"] = "附魔",
        ["Engineering"] = "工程学",
        ...
        ["Goblin"] = "Goblin",
        ["Leatherworking"] = "制皮",
        ["Dragonscale Leatherworking"] = "龙鳞皮革加工",
        ["Elemental Leatherworking"] = "元素皮革加工",
        ["Tribal Leatherworking"] = "部落皮革加工",
        ["Herbalism"] = "草药学",
        ["Mining"] = "采矿",
        ["Smelting"] = "熔炼",
        ["Tailoring"] = "裁缝",
        ...
        ["Leaded Vial"] = "铅瓶",
        ["Silvermoon Remnant"] = "银月余孤",
        ["Revantusk Trolls"] = "破碎獠牙巨魔",
        ...
        ["Lower Karazhan Halls"] = "|cffff0000[团队]|cffffd200 卡拉赞下层",
        ["Emerald Sanctum"] = "|cffff0000[团队]|cffffd200 翡翠圣地",
        ["Gilneas City"] = "|cffffffff[42-50]|cffffd200 吉尔尼斯城",
        ["Matthias Holtz"] = "马修斯·霍尔兹",
        ["Packmaster Ragetooth"] = "兽群之主拉基图斯",
        ["Judge Sutherland"] = "法官萨瑟兰",
        ["Dustivan Blackcowl"] = "达斯蒂文·布莱克考尔",
        ["Marshal Magnus Greystone"] = "元帅玛格努斯·石卫",
        ["Horsemaster Levvin"] = "马匹管理员莱文",
        ["Harlow Family Chest"] = "哈洛家族宝箱",
        ["Genn Greymane"] = "根·格雷迈恩",
        ["Erennius"] = "埃伦尼厄斯",
        ["Solnius the Awakener"] = "唤醒者索尔尼乌斯",
        ["Solnius the Awakener (Page 2)"] = "唤醒者索尔尼乌斯（第2页）",
        ["Favor of Erennius (ES Hard Mode)"] = "埃伦尼厄斯的宠爱（ES 困难模式）",
        ["Master Blacksmith Rolfen"] = "大师铁匠罗尔芬",
        ["Brood Queen Araxxna"] = "蛰伏女王阿拉克斯纳",
        ["Lord Blackwald II"] = "黑翼领主二世",
        ["Clawlord Howlfang"] = "爪牙领主豪弗安",
        ["Grizikil"] = "格里兹基尔",
        ["Moroes"] = "莫罗斯",
        ["LKH Enchants"] = "雷克萨鲁斯的附魔"
    }
end)
